(function (root, factory) {
  if (typeof define === 'function' && define.amd)
    ...
    if (typeof kotlin === 'undefined') {
      throw new Error("Error loading module 'kgl-interface'. Its dependency 'kotlin' was not found. Please, check whether 'kotlin' is loaded prior to 'kgl-interface'.");
    }
    root['kgl-interface'] = factory(typeof this['kgl-interface'] === 'undefined' ? {} : this['kgl-interface'], kotlin);
  }
  ...
  Kotlin.defineModule('kgl-interface', _);
  return _;
}));

//# sourceMappingURL=kgl-interface.js.map
