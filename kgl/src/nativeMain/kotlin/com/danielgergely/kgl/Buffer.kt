...
public actual class FloatBuffer actual constructor(private val buffer: FloatArray) : Buffer() {
...
public actual class ByteBuffer actual constructor(private val buffer: ByteArray) : Buffer() {
