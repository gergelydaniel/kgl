...
interface Kgl {
    ...
    fun texImage2D(target: Int, level: Int, internalFormat: Int, width: Int, height: Int, border: Int, format: Int, type: Int, buffer: PixelBuffer)
    ...
    fun readPixels(x: Int, y: Int, width: Int, height: Int, format: Int, type: Int, pixels: PixelBuffer)
